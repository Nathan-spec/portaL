...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" id="admin_login" name="admin_login" method="post" post="admin_login.php">
    <img class="mb-4" src="img/logo.jpg" width="120" height="120"> </img>
      <h1 class="h3 mb-3 font-weight-normal"><i>Please sign in</i></h1>
